...
namespace Car_Models
{
    ...
    public class New_Model_Rates : Activity
    {
        ...
        private void load_spiner_Master_Company()
        {
            ...
            Car_Models .Resources.Adapter_Company  da = new Resources.Adapter_Company(this, List_All_Master_Comapny);
        ...
        private void load_spiner_Models()
        {
           ...
           Car_Models .Resources.Adapter_Models  da = new Resources.Adapter_Models(this, List_All_Models);
